...
public class SwingUtils {
	 ...
	 * 
	 * @param strColor a formatted string with the RGB values separated by comma - e.g. "123,24,255"
	 ...
	 * @param strFirstElement the value of the first element, or null if it's not desired
	 */
	...
	/**
	 * adds an escpae listener to the dialog, so that pressing escape key, the dialog will close
	 * 
	 * @param dialog
	 */
